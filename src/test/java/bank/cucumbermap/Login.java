...
public void user_opens_browser_with_exe(String bname, String epath) throws Throwable 
{
...
@Then("^user is on \"([^\"]*)\" page and get msg$")
public void user_is_on_page_and_get_msg(String msg) throws Throwable
{
